...
public class PlayerMovment : MonoBehaviour
{
    ...
    [SerializeField]
    private float knocBackTime;
    private float _knocBackCounter;
   [SerializeField] TrailRenderer trailRenderer;
    ...
    void Update()
    {
        ...
        {
            _knocBackCounter -= Time.deltaTime;
        }
    ...
    public void SetSlopeSlideVelocity()
    {
    ...
    public void IncreaseJump()
    {
        ...
        if (playerInventory.NumberOfDiamonds == 30)
        {
            _jumpHeight = 17f;
        }
    }
